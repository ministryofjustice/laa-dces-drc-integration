...
class FdcTestDataCreatorServiceTest {
    ...
    @Test
    void test_whenCreateDelayedPickupTestDataNegativeSod_thenShouldUpdateSod() throws InterruptedException {
        ...
        checkRequestAndBody("POST", "/debt-collection-enforcement/fdc-items",
                "{\"fdcId\":1001,\"dateCreated\":\"" + getDateAfterMonths(0) + ",\"userCreated\":\"DCES\"}");
        ...
        checkRequestAndBody("POST", "/debt-collection-enforcement/fdc-items",
                "{\"fdcId\":1002,\"dateCreated\":\"" + getDateAfterMonths(0) + ",\"userCreated\":\"DCES\"}");
        ...
        checkRequestAndBody("POST", "/debt-collection-enforcement/fdc-items",
                "{\"fdcId\":1003,\"dateCreated\":\"" + getDateAfterMonths(0) + ",\"userCreated\":\"DCES\"}");
        checkRequestAndBody("PATCH", "/assessment/rep-orders/3", "{\"sentenceOrderDate\":null}");
    }

    @Test
    void test_whenCreateDelayedPickupTestDataNegativeCco_thenShouldDeleteCco() throws InterruptedException {
    ...
    @Test
    void test_whenCreateDelayedPickupTestDataNegativeFdcStatus_thenShouldUpdateFdcContributionToSent() throws InterruptedException {
    ...
    @Test
    void test_whenCreateDelayedPickupTestDataNegativeFdcItem_thenShouldDeleteFdcItems() throws InterruptedException {
    ...
    @Test
    void test_whenCreateFastTrackTestDataPositiveAcceleration_thenShouldCreateContributionAndFdcItem() throws InterruptedException {
    ...
    @Test
    void test_whenCreateFastTrackTestDataPositiveAccelerationNegSod_thenShouldDoSevenMonths() throws InterruptedException {
    ...
    @Test
    void test_whenCreateFastTrackTestDataPositiveAccelerationNegCco_thenShouldDeleteCco() throws InterruptedException {
    ...
    @Test
    void test_whenCreateFastTrackTestDataPositiveAccelerationNegFdcStatus_thenShouldUpdateFdcContributionsToSent() throws InterruptedException {
        Set<Integer> refIds = fdcTestDataCreatorService.createFastTrackTestData(FdcAccelerationType.POSITIVE, NEGATIVE_FDC_STATUS, 1);
        assertEquals(1, refIds.size());
        checkRequest("GET", "/assessment/rep-orders?delay=-3&dateReceived=2015-01-01&numRecords=1&fdcDelayedPickup=false&fdcFastTrack=true");
        checkRequestAndBody("PUT", "/assessment/rep-orders",
                "{\"repId\":1,\"sentenceOrderDate\":\"" + getDateAfterMonths(-3) + "\"}");
        checkRequestAndBody("POST", "/debt-collection-enforcement/fdc-contribution",
                "{\"repId\":1,\"lgfsComplete\":\"Y\",\"agfsComplete\":\"Y\",\"manualAcceleration\":\"Y\",\"status\":\"WAITING_ITEMS\"}");
        checkRequestAndBody("POST", "/debt-collection-enforcement/fdc-items",
                "{\"fdcId\":1001,\"dateCreated\":\"" + getDateAfterMonths(0) + ",\"userCreated\":\"DCES\"}");
    ...
    @Test
    void test_whenCreateFastTrackTestDataPositiveAccelerationNegFdcItem_thenShouldDeleteFdcItem() throws InterruptedException {
    ...
    @Test
    void test_whenCreateFastTrackTestDataNegativeAcceleration_thenShouldCreateTwoFdcItems() throws InterruptedException {
        ...
        checkRequestAndBody("POST", "/debt-collection-enforcement/fdc-contribution",
                "{\"repId\":1,\"lgfsComplete\":\"Y\",\"agfsComplete\":\"Y\",\"status\":\"WAITING_ITEMS\"}");
        checkRequestAndBody("POST", "/debt-collection-enforcement/fdc-items",
                "{\"fdcId\":1001,\"itemType\":\"LGFS\",\"dateCreated\":\"" + getDateAfterMonths(0) + ",\"paidAsClaimed\":\"Y\",\"latestCostInd\":\"Current\",\"userCreated\":\"DCES\"}");
        checkRequestAndBody("POST", "/debt-collection-enforcement/fdc-items",
                "{\"fdcId\":1001,\"itemType\":\"AGFS\",\"adjustmentReason\":\"Pre AGFS Transfer\",\"dateCreated\":\"" + getDateAfterMonths(0) + ",\"paidAsClaimed\":\"N\",\"latestCostInd\":\"Current\",\"userCreated\":\"DCES\"}");
    }

    @Test
    void test_whenCreateFastTrackTestDataPrevFdc_thenShouldCreateTwoContributions() throws InterruptedException {
    ...
    @Test
    void test_whenCreateFastTrackTestDataPrevFdcNegative_thenShouldCreateTwoWaitingContributions() throws InterruptedException {
        ...
        checkRequestAndBody("POST", "/debt-collection-enforcement/fdc-contribution",
                "{\"repId\":1,\"lgfsComplete\":\"Y\",\"agfsComplete\":\"Y\",\"status\":\"SENT\"}");
        checkRequestAndBody("POST", "/debt-collection-enforcement/fdc-items",
                "{\"fdcId\":1001,\"adjustmentReason\":\"Other\",\"dateCreated\":\"" + getDateAfterMonths(0) + ",\"userCreated\":\"DCES\"}");
        checkRequestAndBody("PATCH", "/debt-collection-enforcement/fdc-contribution",
     ...
     */
    private RecordedRequest checkRequest(String expectedMethod, String expectedRequestPath) throws InterruptedException {
    ...
    /**
     * Utility method to check that no more requests are received by the mock server (to ensure that the next test can
     * proceed).
     *
     * @throws InterruptedException Thrown by mockWebServer.takeRequest
     */
    @AfterEach
    public void checkNullRequest() throws InterruptedException {
        RecordedRequest recordedRequest = mockWebServer.takeRequest(1, TimeUnit.SECONDS);
