...
public class AckServiceUtils {
    ...
    /**
     * Create an ErrorResponseException for a duplicate Contribution acknowledgement request
     */
    public static ErrorResponseException buildDuplicateContributionRequestException() {
        return buildDuplicateRequestException("Contribution");
    }

    /**
     * Create an ErrorResponseException for a duplicate FDC acknowledgement request
     */
    public static ErrorResponseException buildDuplicateFdcRequestException() {
        return buildDuplicateRequestException("FDC");
    }

    private static ErrorResponseException buildDuplicateRequestException(String contribType) {
        ProblemDetail problemDetail = ProblemDetail.forStatus(CONFLICT.value());
        problemDetail.setType(DUPLICATE_REQUEST);
        problemDetail.setTitle(contribType + " acknowledgment already processed");
